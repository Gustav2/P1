...
plt.axline((0.08, 0), (0.08, 60), color = "red", linestyle = "dashed", label = "Subject sits")
...
plt.title('Pressure by toilet seat as a function of time for Force Sensor FSR-402')
plt.ylim(200,1400)
plt.xlabel('Time (sec)')
